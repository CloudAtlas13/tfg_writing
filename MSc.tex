...
\def\thesismonth{06}						% Month thesis submitted
\def\thesisauthor{Ignacio Penas Fernández}					% Thesis authoreiningaraðferðinni
\def\thesistitle{ANALISYS OF ENERGY PRICING AND WORKLOAD ALLOCATION STRATEGIES IN THE SMARTGRID  IN GEO-DISTRIBUTED DATA CENTERS} 						% Title of thesis
...
\def\thesisschool{Escuela Técnica Superior de Ingenieros de Telecomunicación}		% School
\def\thesisfaculty{Escuela Técnica Superior de Ingenieros de Telecomunicación}							% Faculty
...
\begin{center}
\vspace*{1cm}
\includegraphics[width=43.6mm]{UI.png}\\
\vspace*{2.0cm}
\huge \sffamily \bfseries \thesistitle

\vspace*{2cm}
\normalfont \Large \sffamily \centering \thesisauthor
\AddToShipoutPicture*{\BackgroundPic}
\vfill
